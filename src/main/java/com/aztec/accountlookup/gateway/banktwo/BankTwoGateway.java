...
public class BankTwoGateway {
    ...
    private AccountLookupProperties.BankTwoConfig config;

    public BankTwoGateway(@Autowired AccountLookupProperties properties) {
        this.config = properties.getEndpoints().getBankTwo();
    ...
    public BankTwoAccountResponse accountLookup(final String iban, final String country, final String currency) {
